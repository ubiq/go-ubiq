...
import (
	...
	"github.com/ubiq/go-ubiq/v7/internal/shutdowncheck"
	"github.com/ubiq/go-ubiq/v7/les/downloader"
	"github.com/ubiq/go-ubiq/v7/les/vflux"
	vfc "github.com/ubiq/go-ubiq/v7/les/vflux/client"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightEthereum, error) {
	...
	leth := &LightEthereum{
		...
		merger:          merger,
		engine:          ethconfig.CreateConsensusEngine(stack, chainConfig, &config.Ubqhash, nil, false, chainDb),
