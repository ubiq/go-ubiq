...
func TestHDPathParsing(t *testing.T) {
	tests := []struct {
		...
		{"0", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0}},
		{"128", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 128}},
		{"0'", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0x80000000 + 0}},
		{"128'", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0x80000000 + 128}},
		...
		{"0x00", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0}},
		{"0x80", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 128}},
		{"0x00'", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0x80000000 + 0}},
		{"0x80'", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0x80000000 + 128}},
		{"0x80000000", DerivationPath{0x80000000 + 44, 0x80000000 + 108, 0x80000000 + 0, 0, 0x80000000 + 0}},
...
func TestHdPathIteration(t *testing.T) {
	testDerive(t, DefaultIterator(DefaultBaseDerivationPath),
		[]string{
			"m/44'/108'/0'/0/0", "m/44'/108'/0'/0/1",
			"m/44'/108'/0'/0/2", "m/44'/108'/0'/0/3",
			"m/44'/108'/0'/0/4", "m/44'/108'/0'/0/5",
			"m/44'/108'/0'/0/6", "m/44'/108'/0'/0/7",
			"m/44'/108'/0'/0/8", "m/44'/108'/0'/0/9",
		})

	testDerive(t, DefaultIterator(LegacyLedgerBaseDerivationPath),
		[]string{
			"m/44'/108'/0'/0", "m/44'/108'/0'/1",
			"m/44'/108'/0'/2", "m/44'/108'/0'/3",
			"m/44'/108'/0'/4", "m/44'/108'/0'/5",
			"m/44'/108'/0'/6", "m/44'/108'/0'/7",
			"m/44'/108'/0'/8", "m/44'/108'/0'/9",
		})

	testDerive(t, LedgerLiveIterator(DefaultBaseDerivationPath),
		[]string{
			"m/44'/108'/0'/0/0", "m/44'/108'/1'/0/0",
			"m/44'/108'/2'/0/0", "m/44'/108'/3'/0/0",
			"m/44'/108'/4'/0/0", "m/44'/108'/5'/0/0",
			"m/44'/108'/6'/0/0", "m/44'/108'/7'/0/0",
			"m/44'/108'/8'/0/0", "m/44'/108'/9'/0/0",
		})
}
