...
func testStatusFunctions(t *testing.T, client *rpc.Client) {
	...
	if gasPrice.Cmp(big.NewInt(1000000000)) != 0 { // TODO(iquidus): this will need adjusting
	...
	if gasTipCap.Cmp(big.NewInt(234375000)) != 0 { // TODO(iquidus): this will need adjusting
